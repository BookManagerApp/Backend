...
func main() {
	...
	routes.SetupBookRoutes(app) // Pastikan fungsi ini ada dalam paket route

	// Menambahkan rute untuk menyajikan file statis dari direktori "images"
	// app.Static("/img", "./images") // Path yang benar jika Anda ingin menyajikan file dari folder 'images'
